...
const PostCard = ({
  ...
  const formatTime = (timestamp) => {
    ...
    if (isNaN(date.getTime()))
      return typeof timestamp === "string" ? timestamp : "vừa xong";
      ...
      >
        ...
        >
          {avatar ? (
            ...
            <span
              className="post-avatar-initials-small"
              style={{
                display: "flex",
                alignItems: "center",
      ...
      {isExpanded && (
        ...
        >
          ...
          >
            ...
            >
              <div
                className="post-avatar-extra-small"
                style={{
                  width: "28px",
                  height: "28px",
                  borderRadius: "50%",
                          ...
                          >
                            ...
                            >
                              <svg width="14" height="14" viewBox="0 0 16 16">
                                <path
                                  fill="currentColor"
                                  d="M2 7v7h3V7H2zm4 7h6.5c.6 0 1.2-.4 1.4-1l1.5-4.5c.1-.2.1-.4.1-.5V7c0-.6-.4-1-1-1H9.8L11 3.2c.1-.2.1-.5 0-.8-.1-.2-.4-.4-.7-.4H9.5L6 6v8z"
                                />
                              </svg>{" "}
                              Thích
                            </button>
                          ...
                          >
                            {comment.replies.map((reply) => (
                              ...
                              >
                                ...
                                <div
                                  className="reply-content-wrapper"
                                  style={{ flex: 1 }}
                                >
                                  <span
          ...
          {comments.length > 0 && (
            <div style={{ textAlign: "center", marginTop: "16px" }}>
              ...
              >
                Xem tất cả bình luận ở trang chi tiết
              </span>
            </div>
          )}
        </div>
