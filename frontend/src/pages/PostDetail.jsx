          ...
          <div className="vote-col">
            ...
            >
              <svg
                ...
                style={{
                  color:
                    upvoteState === 1 ? "var(--primary-color)" : "currentColor",
                }}
              >
          ...
          <div className="post-cell">
            ...
            >
              ...
              <button
                ...
                style={{ color: isSaved ? "var(--primary-color)" : "inherit" }}
              >
                {isSaved ? "Đã lưu" : "Lưu"}
              </button>
            </div>
                  ...
                  {comment.replies &&
                    comment.replies.map((reply) => (
                      ...
                      >
                        ...
                        >
                          {reply.userAvatarURL ? (
                            <img src={reply.userAvatarURL} alt="" />
                          ) : (
                            <div
                              style={{
                                width: "100%",
